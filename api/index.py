...
# --- CORS FIX ---
# This allows ALL origins ("*"). Safe for this use case.
...
def chat():
    ...
    try:
        ...
        # 4. Define System Prompt (Cleaned up indentation)
        system_prompt = """You operate under two distinct roles with a clear hierarchy.
...
Always prioritize your Primary Role. Do not promote Elegets Electronics or mention its services unless the user asks you about the company first or asks who you are."""
        ...
        # Check for non-200 errors specifically
        ...
        traceback.print_exc() # Prints full error trace to Vercel logs
